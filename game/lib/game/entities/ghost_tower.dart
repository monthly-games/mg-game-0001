...
class GhostTower extends PositionComponent
  ...
  void render(Canvas canvas) {
    ...
    final rangePaint = Paint()
      ..color = isValid
          ? MGColors.textHighEmphasis.withValues(alpha: 0.3)
          : MGColors.error.withValues(alpha: 0.3)
      ..style = PaintingStyle.fill;
    canvas.drawCircle(Offset(size.x / 2, size.y / 2), range, rangePaint);

    final rangeBorder = Paint()
      ..color = isValid ? MGColors.textHighEmphasis : MGColors.error
    ...
    final ghostPaint = Paint()
      ..color = isValid
          ...
          : MGColors.error.withValues(alpha: 0.5);

...
const kGameTitle = 'Simple Tower Defense';
...
const kLevelDesign = <GameLevelDesign>[
  ...
  GameLevelDesign(
    ...
    wave: 2,
    difficulty: 1.15,
    objective: 'Hold the lane: Choose the first upgrade path',
    goldReward: 80,
    xpReward: 35,
  ...
  GameLevelDesign(
    ...
    wave: 3,
    difficulty: 1.35,
    objective: 'Hold the lane: Chain two systems for a stronger result',
    goldReward: 120,
    xpReward: 54,
  ...
  GameLevelDesign(
    ...
    wave: 4,
    difficulty: 1.65,
    objective: 'Hold the lane: React before timer or resource pressure peaks',
    goldReward: 170,
    xpReward: 78,
  ...
  GameLevelDesign(
    ...
    wave: 6,
    difficulty: 2.30,
    objective: 'Hold the lane: Clear the boss wave and protect progress',
    goldReward: 315,
    xpReward: 144,
  ...
  GameLevelDesign(
    ...
    wave: 7,
    difficulty: 2.70,
    objective: 'Hold the lane: Combine three decisions under higher pressure',
    goldReward: 410,
    xpReward: 188,
  ...
  GameLevelDesign(
    ...
    wave: 8,
    difficulty: 3.15,
    objective: 'Hold the lane: Return for a harder run and better reward',
    goldReward: 525,
    xpReward: 240,

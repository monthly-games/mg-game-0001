...
import 'package:tower_defense/ui/screens/leaderboard_screen.dart';
...
class MyApp extends StatefulWidget {
  ...
  static const gameId = 'MG-0001';
  static const gameTitle = 'Simple Tower Defense';
...
class _MyAppState extends State<MyApp> {
  // Use synchronous value to avoid web loading issues
  ...
  Future<void> _loadTutorialStatus() async {
    try {
      ...
      // If SharedPreferences fails, default to false (show tutorial)
      print('Tutorial status load error: $e');
    }
  }
...
class GamePage extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return GameScreen(initialLevelIndex: stageNumber - 1);
  }
}
...
class TutorialFlowScreen extends StatefulWidget {
  const TutorialFlowScreen({super.key, this.onCompleted});
      ...
      body: Column(
        children: [
          ...
          Expanded(
            child: Center(
              child: AspectRatio(
                aspectRatio: 9 / 16, // Fixed mobile portrait ratio
                child: SizedBox.expand(
                  child: FittedBox(
                    ...
                    child: SizedBox(
                      width: 360,
                      height: 640,
                      child: GameWidget(game: _FrameLoopGame()),
                    ),
                  ),
                ),
              ),
